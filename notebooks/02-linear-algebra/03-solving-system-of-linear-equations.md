...
But sometimes there are nonzero/Non-trivial solutions too.
...
!!! intuition
    While bring $A$ to reduced row echelon form, If we dont yield an identity matrix, it means that the matrix is not invertible (singular matrix).
